...
void Viewer::Run() {
    shutdown_trace::log("orb.viewer", "Run enter");
    mbFinished = false;
    mbStopped = false;
    ...
    SetFinish();
    shutdown_trace::log("orb.viewer", "Run exit");
}

void Viewer::RequestFinish() {
    shutdown_trace::log("orb.viewer", "RequestFinish");
...
void Viewer::SetFinish() {
    unique_lock<mutex> lock(mMutexFinish);
    mbFinished = true;
    shutdown_trace::log("orb.viewer", "SetFinish");
}
