...
void LocalMapping::Run() {
    shutdown_trace::log("orb.local_mapping", "Run enter");
    mbFinished = false;
    ...
    SetFinish();
    shutdown_trace::log("orb.local_mapping", "Run exit");
}
...
void LocalMapping::RequestFinish() {
    shutdown_trace::log("orb.local_mapping", "RequestFinish");
...
void LocalMapping::SetFinish() {
    ...
    mbStopped = true;
    shutdown_trace::log("orb.local_mapping", "SetFinish");
}
