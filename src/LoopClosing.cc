...
void LoopClosing::Run() {
    shutdown_trace::log("orb.loop_closing", "Run enter");
    mbFinished = false;
    ...
    SetFinish();
    shutdown_trace::log("orb.loop_closing", "Run exit");
}
...
void LoopClosing::RequestFinish() {
    shutdown_trace::log("orb.loop_closing", "RequestFinish");
...
void LoopClosing::SetFinish() {
    unique_lock<mutex> lock(mMutexFinish);
    mbFinished = true;
    shutdown_trace::log("orb.loop_closing", "SetFinish");
}
