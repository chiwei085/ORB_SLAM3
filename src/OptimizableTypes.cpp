...
void EdgeSE3ProjectXYZ::linearizeOplus() {
    ...
    // Materialize the Eigen expression to avoid holding references to
    // temporaries (ASAN stack-use-after-scope in linearizeOplus).
    Eigen::Matrix<double, 2, 3> projectJac =
